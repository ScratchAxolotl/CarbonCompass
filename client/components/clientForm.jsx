  ...
  return (
    <div>
      ...
      <form onSubmit={()=>submitForm()}>
        <label>Country</label>
        <select onChange={(e)=>countrySelection(e)} class="form-select" autocomplete="country" id="country" name="country">
        ...
        <select onChange={(e)=>stateSelection(e)} id="state-options">
